...
fig.savefig("isosurface_single.png", dpi=150, bbox_inches="tight", facecolor="white")
plt.close(fig)
print("Saved: isosurface_single.png")
...
fig.savefig("isosurface_nested.png", dpi=150, bbox_inches="tight", facecolor="white")
plt.close(fig)
print("Saved: isosurface_nested.png")

# ── Different camera angle to show the 3-D structure ──────────────────────────
...
fig.savefig("isosurface_rotated.png", dpi=150, bbox_inches="tight", facecolor="white")
plt.close(fig)
print("Saved: isosurface_rotated.png")
